...
class ST7789V(DisplayBase):
    ...
    def cmd_caset(self, x, cx):
        self.cmd(ST7789V_CMD_CASET, [numpy.uint64(x) >> numpy.uint64(8), numpy.uint64(x) & numpy.uint64(0xff), numpy.uint64(cx) >> numpy.uint64(8), numpy.uint64(cx) & numpy.uint64(0xff)])
    def cmd_raset(self, y, cy):
        self.cmd(ST7789V_CMD_RASET, [numpy.uint64(y) >> numpy.uint64(8), numpy.uint64(y) & numpy.uint64(0xff), numpy.uint64(cy) >> numpy.uint64(8), numpy.uint64(cy) & numpy.uint64(0xff)])
    def init(self):
